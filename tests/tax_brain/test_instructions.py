...
def parse_result():
    from tax_brain.instructions.html_parser import parse_instruction_html
...
class TestHTMLParser:
    ...
    def test_section_types_assigned(self, parse_result):
        ...
        from tax_brain.instructions.models import SectionType
...
class TestLayer2Structural:
    ...
    def v21_report(self, parse_result):
        from tax_brain.instructions.validation import structural as v2_structural
...
class TestLinkCoverage:
    ...
    def v22_report(self, parse_result):
        from tax_brain.instructions.validation import link_coverage
