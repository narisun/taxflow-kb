...
Covers:
  - GoldSetEntry and GoldSet (evaluation.models)
...
from taxkb.evaluation.models import GoldSetEntry, GoldSet
from taxkb.evaluation.retrieval_evaluator import (
    RetrievalEvalResult,
    RetrievalReport,
    evaluate_retrieval,
)
...
from taxkb.evaluation.generation_evaluator import (
...
class TestEvaluateGeneration:
    ...
    @patch("taxkb.evaluation.generation_evaluator._call_judge")
...
from taxkb.evaluation.validation.gold_set import (
    validate_gold_set,
...
from taxkb.evaluation.gold_set_patcher import patch_adjacent_chunks
...
class TestPatchAdjacentChunks:
    ...
    def _make_store_mock(self, chunk_ids_by_pub: dict[str, list[str]]):
        """Return a mock PublicationStore whose _cursor returns ordered chunk IDs."""
        store = MagicMock()
