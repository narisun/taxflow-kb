...
def _make_result(
    ...
    from taxkb.publications.models import Layer3ParseResult, Publication
...
class TestModels:
    ...
    def test_publication_defaults(self):
        from taxkb.publications.models import Publication
        pub = Publication(
            pub_id    = "p17-2025",
            pub_number= "17",
    ...
    def test_retrieval_result_construction(self):
        from taxkb.publications.models import RetrievalResult
        rr = RetrievalResult(
...
class TestPDFParserHelpers:
    ...
    def test_count_tokens_fallback(self):
        ...
        from taxkb.publications.pdf_parser import _count_tokens
    ...
    def test_detect_heading_chapter(self):
        ...
        from taxkb.publications.pdf_parser import _detect_heading
    ...
    def test_chunk_paragraphs_respects_max_tokens(self):
        ...
        from taxkb.publications.pdf_parser import _chunk_paragraphs, _count_tokens, HARD_MAX
    ...
    def test_split_paragraphs_on_blank_lines(self):
        ...
        from taxkb.publications.pdf_parser import _split_paragraphs
    ...
    def test_extract_refs_finds_form(self):
        ...
        from taxkb.publications.pdf_parser import _extract_refs
...
class TestV31Structural:
    ...
    def test_passes_with_valid_result(self):
        ...
        from taxkb.publications.validation.structural import validate_structural
    ...
    def test_fails_on_too_few_chunks(self):
        ...
        from taxkb.publications.validation.structural import validate_structural, MIN_CHUNKS
...
class TestV32Coverage:
    ...
    def test_passes_when_all_pubs_present(self):
        ...
        from taxkb.publications.validation.coverage import (
    ...
    def test_fails_when_pub_missing(self):
        ...
        from taxkb.publications.validation.coverage import validate_coverage_from_results
...
class TestV33Retrieval:
    ...
    def _build_probe_chunks(self, probes, num_extra=5):
        ...
        """
        from taxkb.publications.validation.retrieval import RetrievalProbe
    ...
    def test_passes_with_perfect_embeddings(self):
        ...
        from taxkb.publications.validation.retrieval import (
            validate_retrieval_from_chunks, PROBES,
        )
        chunks = self._build_probe_chunks(PROBES)
        with patch(
            "taxkb.publications.embeddings.embed_query",
