...
class TestPublicationRegistry:
    """Tests for taxkb/publications/registry.py"""
    ...
    def test_get_registry_returns_registry(self):
        ...
        from taxkb.publications.registry import PublicationRegistry
    ...
    def test_get_pub_titles_returns_dict_with_at_least_8_pubs(self):
        ...
        from taxkb.publications.registry import get_pub_titles
...
class TestQueryClassifier:
    """Tests for taxkb/agent/classifier.py"""
    ...
    def test_classify_query_standard_deduction_lookup(self):
        ...
        from taxkb.agent.classifier import classify_query, QueryIntent
    ...
    def test_suggest_pub_filter_returns_list_or_none(self):
        ...
        from taxkb.agent.classifier import classify_query, suggest_pub_filter
...
class TestChunkEnrichment:
    """Tests for taxkb/layer3/chunk_enrichment.py"""
    ...
    def test_enrich_for_embedding_returns_string(self, mock_chunk_pub596):
        ...
        from taxkb.publications.chunk_enrichment import enrich_for_embedding
    ...
    def test_enrichment_registry_has_registered_enrichers(self):
        ...
        from taxkb.publications.chunk_enrichment import EnrichmentRegistry
...
class TestModelsLayer4Pydantic:
    """Tests for taxkb/agent/models.py — Pydantic models"""
...
class TestProtocols:
    """Tests for taxkb/protocols.py — Protocol definitions"""
    ...
    def test_connection_pool_protocol_exists(self):
        ...
        from taxkb.protocols import ConnectionPool
    ...
    def test_completion_client_protocol_exists(self):
        ...
        from taxkb.protocols import CompletionClient
    ...
    def test_chunk_enricher_protocol_exists(self):
        ...
        from taxkb.protocols import ChunkEnricher
    ...
    def test_pg_connection_pool_class_exists(self):
        ...
        from taxkb.adapters import PgConnectionPool
    ...
    def test_openai_embedding_client_exists(self):
        ...
        from taxkb.adapters import OpenAIEmbeddingClient
    ...
    def test_protocols_are_runtime_checkable(self):
        ...
        from taxkb.protocols import ConnectionPool, EmbeddingClient
