...
SAMPLE_HTML = pathlib.Path(__file__).parent.parent.parent / \
...
class TestHTMLParser:
    ...
    def test_section_types_assigned(self, parse_result):
        ...
        from taxkb.instructions.models import SectionType
...
class TestLayer2Structural:
    ...
    def v21_report(self, parse_result):
        from taxkb.instructions.validation import structural as v2_structural
        return v2_structural.run(parse_result)
    ...
    def test_v21_fails_on_empty_result(self):
        ...
        from taxkb.instructions.models import (
        ...
        report = v2_structural.run(empty_result)
...
class TestLinkCoverage:
    ...
    def v22_report(self, parse_result):
        from taxkb.instructions.validation import link_coverage
        return link_coverage.run(parse_result)
