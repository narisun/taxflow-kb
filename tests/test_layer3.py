...
def _make_result(
    ...
    from taxflow_kb.layer3.models_layer3 import Layer3ParseResult, Publication
...
class TestPDFParserHelpers:
    ...
    def test_count_tokens_fallback(self):
        ...
        from taxflow_kb.layer3.pdf_parser import _count_tokens
    ...
    def test_detect_heading_chapter(self):
        ...
        from taxflow_kb.layer3.pdf_parser import _detect_heading
    ...
    def test_chunk_paragraphs_respects_max_tokens(self):
        ...
        from taxflow_kb.layer3.pdf_parser import _chunk_paragraphs, _count_tokens, HARD_MAX
    ...
    def test_split_paragraphs_on_blank_lines(self):
        ...
        from taxflow_kb.layer3.pdf_parser import _split_paragraphs
    ...
    def test_extract_refs_finds_form(self):
        ...
        from taxflow_kb.layer3.pdf_parser import _extract_refs
...
class TestV31Structural:
    ...
    def test_fails_on_too_few_chunks(self):
        ...
        from taxflow_kb.layer3.validation.v3_1_structural import validate_structural, MIN_CHUNKS
...
class TestV32Coverage:
    ...
    def test_passes_when_all_pubs_present(self):
        ...
        from taxflow_kb.layer3.validation.v3_2_coverage import (
    ...
    def test_fails_when_pub_missing(self):
        ...
        from taxflow_kb.layer3.validation.v3_2_coverage import validate_coverage_from_results
...
class TestV33Retrieval:
    ...
    def _build_probe_chunks(self, probes, num_extra=5):
        ...
        """
        from taxflow_kb.layer3.validation.v3_3_retrieval import RetrievalProbe
    ...
    def test_passes_with_perfect_embeddings(self):
        ...
        from taxflow_kb.layer3.validation.v3_3_retrieval import (
            validate_retrieval_from_chunks, PROBES,
        )
        chunks = self._build_probe_chunks(PROBES)
        with patch(
            "taxflow_kb.layer3.embeddings.embed_query",
