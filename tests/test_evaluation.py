...
from tax_brain.evaluation.retrieval_evaluator import (
    RetrievalEvalResult,
    RetrievalReport,
    evaluate_retrieval,
)
...
from tax_brain.evaluation.generation_evaluator import (
...
class TestEvaluateGeneration:
    ...
    @patch("tax_brain.evaluation.generation_evaluator._call_judge")
...
from tax_brain.evaluation.validation.gold_set import (
    validate_gold_set,
