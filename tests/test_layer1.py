...
from taxflow_kb.validation import v1_1_structural, v1_3_test_replay
from taxflow_kb.validation.v1_1_structural import StructuralCheckConfig
from taxflow_kb.validation.v1_3_test_replay import (
    RuleEngine, build_synthetic_test_cases,
)

SAMPLE_CSV = Path(__file__).parent.parent / "data/sample/mef_1040_2024_v5_2.csv"
...
class TestV11Structural:
    ...
    def test_v11_passes_on_clean_csv(self, parsed):
        rules, result = parsed
        report = v1_1_structural.run(rules, result)
    ...
    def test_v11_fails_on_row_count_mismatch(self, parsed):
        ...
        report = v1_1_structural.run(rules, result, cfg)
...
class TestV13Replay:
    ...
    def test_full_replay_suite_passes_gate(self, rules):
        ...
        report, _ = v1_3_test_replay.run(rules)
