"""
taxkb/cli/evaluation_commands.py
...
def cmd_generate_gold_set(args) -> int:
    ...
    from taxkb.evaluation.gold_set_generator import generate_gold_set
    from taxkb.evaluation.models import GoldSet
...
def cmd_evaluate_generation(args) -> int:
    ...
    from taxkb.evaluation.models import GoldSet
    from taxkb.evaluation.generation_evaluator import evaluate_generation
...
def cmd_validate_gold_set(args) -> int:
    ...
    from taxkb.evaluation.models import GoldSet
    from taxkb.evaluation.validation.gold_set import validate_gold_set
...
def cmd_evaluate_retrieval(args) -> int:
    ...
    from taxkb.evaluation.models import GoldSet
    from taxkb.evaluation.retrieval_evaluator import evaluate_retrieval
