...
Usage:
    python taxkb/scripts/diagnose_retrieval_gaps.py
    python taxkb/scripts/diagnose_retrieval_gaps.py --pub 535
    python taxkb/scripts/diagnose_retrieval_gaps.py --query "What business expenses are deductible?"
"""
