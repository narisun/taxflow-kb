#!/usr/bin/env python3
"""
cli/main.py — TaxFlow AI Knowledge Base CLI entry point.
...
def main() -> int:
    ...
    from cli.rules_commands import cmd_ingest, cmd_validate, cmd_sample, cmd_score, cmd_diff
    from cli.instructions_commands import cmd_ingest_instructions, cmd_validate_instructions
    from cli.publications_commands import (
    ...
    from cli.agent_commands import cmd_ask, cmd_validate_agent
    from cli.evaluation_commands import (
