...
def cmd_ingest_instructions(args) -> int:
    ...
    if args.neo4j_uri:
        ...
        from tax_brain.instructions.neo4j_store import InstructionGraphStore
    ...
    if args.pg_dsn:
        import psycopg2
        from tax_brain.instructions.postgres_store import InstructionStore
...
def cmd_validate_instructions(args) -> int:
    from tax_brain.instructions.html_parser import parse_instruction_html
    from tax_brain.instructions.validation import structural as v2_structural, link_coverage
