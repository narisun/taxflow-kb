...
from tax_brain.agent import synthesizer as _syn
from tax_brain.agent.reranker import rerank_chunks, apply_positional_optimization
from tax_brain.agent.compressor import compress_contexts
from tax_brain.agent.classifier import classify_query, QueryMetadata
from tax_brain.protocols import ConnectionPool, EmbeddingClient, CompletionClient, Retriever
...
class TaxBrainAgent:
    ...
    ``tax_brain.factories.create_agent()`` to build a fully wired instance
