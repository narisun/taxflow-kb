"""
tax_brain/layer4/synthesizer.py
...
def _build_context_block(contexts: list[RetrievedPassage], max_chars: int | None = None) -> str:
    """
...
def synthesize(
    ...
    """
    # Use sensible defaults when caller doesn't provide values.
    # In production, TaxBrainAgent always passes explicit values from AgentConfig.
    if model is None:
        model = "gpt-4o"
