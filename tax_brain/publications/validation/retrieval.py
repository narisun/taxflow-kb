"""
tax_brain/publications/validation/retrieval.py
...
def validate_retrieval(
    ...
    Args:
        store   : Connected PublicationStore with embedded chunks.
...
def validate_retrieval_from_chunks(
    ...
    import math
    from tax_brain.publications.embeddings import embed_query
    from tax_brain.publications.models import PublicationChunk, PUB_TITLES
