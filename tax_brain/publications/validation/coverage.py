"""
tax_brain/publications/validation/coverage.py
...
def validate_coverage(
    store,                                # PublicationStore instance
    expected_pubs      : Optional[dict[str, str]] = None,
    require_embeddings : bool = False,
) -> V32Result:
    """
    Run the V3.2 coverage gate against the live database via a PublicationStore.

    Args:
        store              : Connected PublicationStore.
...
def validate_coverage_from_results(
    ...
    """
    from tax_brain.publications.models import Layer3ParseResult
