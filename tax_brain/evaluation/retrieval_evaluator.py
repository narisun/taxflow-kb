"""
tax_brain/layer5/retrieval_evaluator.py
...
def evaluate_retrieval(
    ...
    retriever,                       # TaxBrainRetriever (already constructed)
    top_k           : int  = 5,
    ...
    Args:
        ...
        retriever       : Connected TaxBrainRetriever.
    ...
    for i, entry in enumerate(entries):
        ...
        try:
            ...
            # TaxBrainRetriever returns 3-tuple (contexts, ms, metadata)
