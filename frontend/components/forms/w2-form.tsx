...
interface W2Data {
  employer_name?: string; employer_ein?: string; employee_name?: string; employee_ssn?: string;
  wages?: number; federal_tax_withheld?: number; social_security_wages?: number;
  social_security_tax?: number; medicare_wages?: number; medicare_tax?: number;
  box_12?: string; state?: string; state_wages?: number; state_tax?: number;
  [key: string]: unknown;
}
