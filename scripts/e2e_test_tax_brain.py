...
Usage:
    python scripts/e2e_test_tax_brain.py              # full synthesis
    python scripts/e2e_test_tax_brain.py --no-synth   # retrieval only (no OpenAI calls)
    python scripts/e2e_test_tax_brain.py -v            # verbose (print context details)
    python scripts/e2e_test_tax_brain.py -t "rental"   # run single test by name
"""
