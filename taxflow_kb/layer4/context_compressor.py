"""
taxflow_kb/layer4/context_compressor.py
...
def compress_contexts(
    ...
    Returns:
        List of RetrievedContext with compressed text. May be shorter than
        input if some chunks had no relevant facts.
    """
    settings = get_settings()
    model = model or settings.compression_model
    ...
    pub_groups: list[tuple[str, list[tuple[int, RetrievedContext]]]] = []
    ...
    compressed_results: list[RetrievedContext] = []
    ...
    for pub_ref, indexed_chunks in pub_groups:
        ...
        try:
            ...
            compressed_ctx = RetrievedContext(
