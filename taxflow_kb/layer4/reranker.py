...
def rerank_chunks(
    ...
    scored: list[tuple[float, int, RetrievedContext]] = []
...
def apply_positional_optimization(chunks: list[RetrievedContext]) -> list[RetrievedContext]:
    """
