"""
taxflow_kb/layer5/gold_set_generator.py
...
def generate_gold_set(
    store            ,                  # Layer3Store (context manager not needed; pass connected)
    api_key          : str,
    ...
    Args:
        store           : Connected Layer3Store (psycopg2 connection open).
