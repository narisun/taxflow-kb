...
def _call_judge(
    ...
    contexts: list,       # list of RetrievedContext
    api_key : str,
    model   : str,
) -> None:
...
def evaluate_generation(
    ...
    agent            ,          # CPAQueryAgent (already constructed)
    api_key          : str,
    ...
    Args:
        ...
        agent           : Initialized CPAQueryAgent.
