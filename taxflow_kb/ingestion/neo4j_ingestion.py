"""
taxflow_kb/ingestion/neo4j_ingestion.py
...
from taxflow_kb.models import MeFRule, RuleVersionDiff, ChangeType
...
class Neo4jIngestion:
    ...
    Usage:
        ingestor = Neo4jIngestion("bolt://localhost:7687", "neo4j", "password")
