"""
taxflow_kb/layer3/postgres_layer3.py
...
Usage:
    ...
    store = Layer3Store(dsn="postgresql://taxflow:taxflow_dev@localhost:5432/taxflow")
...
from taxflow_kb.layer3.models_layer3 import (
...
class Layer3Store:
    ...
    Args:
        ...
        conn     : Supply an existing connection instead of DSN (useful in tests).
    ...
    def __init__(
        ...
        if conn is not None:
            ...
            if dsn is None:
                raise ValueError("Either dsn or conn must be provided.")
            try:
    ...
    def add_bm25_index(self) -> None:
        ...
        HierarchicalRetriever automatically enables hybrid retrieval.
    ...
    def search_bm25(
        ...
        Raises:
            Does NOT raise on missing column — returns [] so HierarchicalRetriever
        ...
        try:
            ...
            # Caller (HierarchicalRetriever) handles the empty list by falling
    ...
    def ingest(
        ...
        if not skip_embedding and chunks:
            try:
                from taxflow_kb.layer3.context_annotator import annotate_chunks
                annotate_chunks(
                    chunks,
                    pub_title=pub.pub_title,
